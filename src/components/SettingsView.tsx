  ...
  return (
    <div className="h-full overflow-y-auto no-scrollbar">
      <section className="rounded-2xl border border-ucla-blue/30 bg-ucla-blue/5 p-4">
        <div className="mb-1 flex items-center gap-2 text-sm font-semibold text-ucla-blue-dark">
          <Sparkles className="h-4 w-4" />
          AI summaries
        </div>
        <p className="text-xs text-slate-600">
          Powered automatically by a backend that keeps the API key private — no setup needed
          here.
        </p>
      </section>
